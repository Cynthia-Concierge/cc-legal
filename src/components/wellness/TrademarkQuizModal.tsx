    ...
    const handleSearchSubmit = async () => {
        ...
        try {
            ...
            if (!user || !user.email) {
                ...
                // Should probably show error, but falling back for now
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.error || 'Failed to submit trademark request');
            }
            ...
            alert(`Error submitting request: ${e.message || 'Unknown error'}. Check console for details.`);
        }
    };
            ...
            <Card className="w-full max-w-lg shadow-2xl border-none max-h-[90vh] overflow-y-auto">
                ...
                {step === 'intro' && (
                    <div className="p-8 text-center space-y-6">
                        ...
                        <h2 className="text-2xl font-bold text-slate-900">Is Your Brand Name Safe?</h2>
                        <p className="text-slate-600 text-lg">
                            Did you know that registering an LLC <span className="font-bold text-slate-800">does not</span> protect your brand name?
                        </p>
                        <p className="text-slate-500">
                            Take this 1-minute quiz to see if your business name is at risk of being stolen or sued.
                        </p>
                        <Button
