        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center lg:items-start">
          ...
          <div className="w-full lg:w-3/5 space-y-8 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border border-emerald-100 text-emerald-800 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider shadow-sm">
              ...
              For Gym Owners & Wellness Pros Only
            </div>

            <h1 className="text-4xl lg:text-6xl font-extrabold text-slate-900 leading-[1.1] tracking-tight font-serif">
              The Must-Have Legal Documents Every <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-500 underline decoration-emerald-200/50 underline-offset-8 decoration-4">Wellness Business</span> Needs.
            </h1>

            <p className="text-lg lg:text-xl text-slate-600 leading-relaxed max-w-2xl mx-auto lg:mx-0">
              Get the exact waivers, contracts, and policies <span className="font-semibold text-slate-900">Conscious Counsel</span> uses to protect <span className="font-semibold text-slate-900">1,000+ studios and retreat leaders</span>. Stop worrying about legal "what ifs" and focus on your community.
            </p>

            {/* Visual Document Representation */}
            <div className="hidden lg:flex relative mt-12 pl-4 h-80 items-center overflow-visible">
