-- ============================================
-- FIX NEW USER SIGNUP FLOW (v2 - Fixed)
-- ============================================
-- Fixes:
...
-- ============================================
-- STEP 2: Drop ONLY user-created triggers on business_profiles
-- (Skip system triggers like foreign key constraints)
-- ============================================
...
BEGIN
  FOR trigger_record IN
    ...
    WHERE t.tgrelid = 'business_profiles'::regclass
      -- Only drop non-system triggers (system triggers start with RI_ConstraintTrigger)
...
DROP POLICY IF EXISTS "users_insert_own_profile" ON business_profiles;
DROP POLICY IF EXISTS "users_select_own_profile" ON business_profiles;
DROP POLICY IF EXISTS "users_update_own_profile" ON business_profiles;
